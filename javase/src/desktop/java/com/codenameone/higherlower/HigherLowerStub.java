 ...
 * @author Shai Almog
 */
public class HigherLowerStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "HigherLower";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new HigherLowerStub());
    }
